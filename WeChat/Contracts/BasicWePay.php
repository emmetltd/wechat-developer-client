...
class BasicWePay
{
    ...
    public function getNotify()
    {
        ...
        if( isset($data['sub_appid']) && isset($data['sub_mch_id'])){
            $sign = Tools::post(self::MCH_SERVICE_SIGN_URL,json_encode($data,JSON_UNESCAPED_UNICODE));
        }else{
            $sign = $this->getPaySign($data);
        }
